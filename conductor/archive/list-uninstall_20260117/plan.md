...
- [x] Task: Write Unit Tests for `list` command logic. 0944817
    - [x] Test filtering by agent.
    - [x] Test filtering by scope.
    - [x] Test default behavior (all agents/scopes).
- [x] Task: Write Unit Tests for `uninstall` command logic. 1e52ce9
    - [x] Test successful uninstallation.
    - [x] Test error handling for missing flags.
- [x] Task: Conductor - User Manual Verification 'List and Uninstall' (Protocol in workflow.md) aeb7cdb
