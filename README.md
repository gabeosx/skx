...
**Agent Skills Manager** - The CLI tool for managing Agent Skills (agentskills.io).

## Overview

`skx` simplifies the discovery, installation, and management of skills for AI agents like Gemini CLI, Claude Code, and Codex. It provides a unified interface to extend your AI agents with new capabilities from the central registry.
...
- **Skill Discovery:** Easily search and list skills from [agentskills.io](https://agentskills.io).
